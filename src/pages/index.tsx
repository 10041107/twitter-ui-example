...
import Footer from '../components/microblog/Footer';
...
export default function Home() {
	return (
		<>
			...
			<div className="flex min-h-screen gap-5 mx-auto max-w-7xl xl:grid xl:grid-cols-10">
				<Nav />
				<main className="w-full col-span-5 border-x border-slate-200">
					<Header title="Home" />
					<Tabs />
				</main>
